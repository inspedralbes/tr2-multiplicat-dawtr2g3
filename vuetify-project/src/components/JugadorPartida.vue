<template>
    <div class="container__jugador jugador">
        <span class="nick">{{ jugador.nick }}  <img :style="{display: 'inline', height:'180px', position:'absolute',right:'14px', transform:'translateY(-110px)' }" v-if="jugador.encertades >= 5 && jugador.encertades < 10"  src="/src/assets/rachas/racha5.gif" alt=""> <img :style="{display: 'inline', height:'50px', position:'absolute',right:'45px', transform:'translateY(-20px)' }" v-if="jugador.encertades >= 0 && jugador.encertades < 15"  src="/src/assets/rachas/racha10.gif" alt=""> <img :style="{display: 'inline', height:'80px', position:'absolute',right:'40px', transform:'translateY(-40px)', zIndex: '0' }" v-if="jugador.encertades >= 15"  src="/src/assets/rachas/racha15.gif" alt=""></span>
