    ...
    <div class="container__jugadors">
      ...
      <div class="containerEncertaresOwnPlayer">
        <div class="containerIcons">
          <div v-for="(item, index) in nEncertades" :key="index" class="encertades">
            <div v-if="ownPlayer.infoPartida.encertades > index">
              <svg xmlns="http://www.w3.org/2000/svg" width="3em" height="3em" viewBox="0 0 16 16">
                <path fill="none" stroke="#3df200" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
